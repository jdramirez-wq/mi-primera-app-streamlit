...
with col1:
    ...
    # BOTÓN DE ENLACE REAL A LA SUBPÁGINA
    st.page_link("pages/1_📊_Auditoria_EVAPLAN.py", label="Ir a Auditoría EVAPLAN", icon="🚀", use_container_width=True)
...
with col2:
    ...
    # BOTÓN DE ENLACE REAL A LA SUBPÁGINA (AUNQUE ESTÉ EN CONSTRUCCIÓN)
    st.page_link("pages/2_📝_POAI_2027.py", label="Explorar Módulo POAI", icon="🚧", use_container_width=True)
